...
#ifndef __MONOSERVICE_SCREEN_UPLOAD_FILE_DAO_H__
#define __MONOSERVICE_SCREEN_UPLOAD_FILE_DAO_H__
...
gchar** monoservice_screen_upload_file_dao_select(MonoserviceMysqlConnector *mysql_connector,
						  guint64 screen_upload_file_id);

void monoservice_screen_upload_file_dao_set_filename(MonoserviceMysqlConnector *mysql_connector,
						     guint64 screen_upload_file_id,
						     gchar *filename);
...
void monoservice_screen_upload_file_dao_set_available(MonoserviceMysqlConnector *mysql_connector,
						      guint64 screen_upload_file_id,
						      gboolean available);

#endif /*__MONOSERVICE_SCREEN_UPLOAD_FILE_DAO_H__*/
