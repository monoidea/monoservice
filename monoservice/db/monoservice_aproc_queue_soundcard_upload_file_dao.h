...
guint64 monoservice_aproc_queue_soundcard_upload_file_dao_create(MonoserviceMysqlConnector *mysql_connector);
void monoservice_aproc_queue_soundcard_upload_file_dao_delete(MonoserviceMysqlConnector *mysql_connector,
							      guint64 aproc_queue_soundcard_upload_file_id);

gchar** monoservice_aproc_queue_soundcard_upload_file_dao_select(MonoserviceMysqlConnector *mysql_connector,
								 guint64 aproc_queue_soundcard_upload_file_id);
