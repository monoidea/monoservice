...
(
  `VIDEO_PROCESSING_QUEUE` INTEGER REFERENCES VIDEO_PROCESSING_QUEUE(VIDEO_PROCESSING_QUEUE_ID),
  `CAM_UPLOAD_FILE` INTEGER REFERENCES CAM_UPLOAD_FILE (CAM_UPLOAD_FILE_ID),
  PRIMARY KEY (`VIDEO_PROCESSING_QUEUE`, `CAM_UPLOAD_FILE`)
)ENGINE=InnoDB DEFAULT CHARSET utf8;
...
(
  ...
  PRIMARY KEY (`VIDEO_PROCESSING_QUEUE`, `SCREEN_UPLOAD_FILE`)
)ENGINE=InnoDB DEFAULT CHARSET utf8;
...
(
  `AUDIO_PROCESSING_QUEUE` INTEGER REFERENCES AUDIO_PROCESSING_QUEUE(AUDIO_PROCESSING_QUEUE_ID),
  `MIC_UPLOAD_FILE` INTEGER REFERENCES MIC_UPLOAD_FILE (MIC_UPLOAD_FILE_ID),
  PRIMARY KEY (`AUDIO_PROCESSING_QUEUE`, `MIC_UPLOAD_FILE`),
)ENGINE=InnoDB DEFAULT CHARSET utf8;
...
(
  ...
  PRIMARY KEY (`AUDIO_PROCESSING_QUEUE`, `SOUNDCARD_UPLOAD_FILE`),
)ENGINE=InnoDB DEFAULT CHARSET utf8;
...
ALTER TABLE VIDEO_PROCESSING_QUEUE_CAM_UPLOAD_FILE
ADD CONSTRAINT VIDEO_PROCESSING_QUEUE_CAM_UPLOAD_FILE_REF_VIDEO_PROCESSING_QUEUE
FOREIGN KEY (VIDEO_PROCESSING_QUEUE)
REFERENCES VIDEO_PROCESSING_QUEUE(VIDEO_PROCESSING_QUEUE_ID);

ALTER TABLE VIDEO_PROCESSING_QUEUE_CAM_UPLOAD_FILE
ADD CONSTRAINT VIDEO_PROCESSING_QUEUE_CAM_UPLOAD_FILE_REF_CAM_UPLOAD_FILE
FOREIGN KEY (CAM_UPLOAD_FILE)
REFERENCES CAM_UPLOAD_FILE(CAM_UPLOAD_FILE_ID);

#----------------------------------------------------------------------------------------

ALTER TABLE VIDEO_PROCESSING_QUEUE_SCREEN_UPLOAD_FILE
ADD CONSTRAINT VIDEO_PROCESSING_QUEUE_SCREEN_UPLOAD_FILE_REF_VIDEO_PROCESSING_QUEUE
FOREIGN KEY (VIDEO_PROCESSING_QUEUE)
REFERENCES VIDEO_PROCESSING_QUEUE(VIDEO_PROCESSING_QUEUE_ID);

ALTER TABLE VIDEO_PROCESSING_QUEUE_SCREEN_UPLOAD_FILE
ADD CONSTRAINT VIDEO_PROCESSING_QUEUE_SCREEN_UPLOAD_FILE_REF_SCREEN_UPLOAD_FILE
FOREIGN KEY (SCREEN_UPLOAD_FILE)
REFERENCES SCREEN_UPLOAD_FILE(SCREEN_UPLOAD_FILE_ID);

#----------------------------------------------------------------------------------------

ALTER TABLE AUDIO_PROCESSING_QUEUE_MIC_UPLOAD_FILE
ADD CONSTRAINT AUDIO_PROCESSING_QUEUE_MIC_UPLOAD_FILE_REF_AUDIO_PROCESSING_QUEUE
FOREIGN KEY (AUDIO_PROCESSING_QUEUE)
REFERENCES AUDIO_PROCESSING_QUEUE(AUDIO_PROCESSING_QUEUE_ID);

ALTER TABLE AUDIO_PROCESSING_QUEUE_MIC_UPLOAD_FILE
ADD CONSTRAINT AUDIO_PROCESSING_QUEUE_MIC_UPLOAD_FILE_REF_MIC_UPLOAD_FILE
FOREIGN KEY (MIC_UPLOAD_FILE)
REFERENCES MIC_UPLOAD_FILE(MIC_UPLOAD_FILE_ID);

#----------------------------------------------------------------------------------------

ALTER TABLE AUDIO_PROCESSING_QUEUE_SOUNDCARD_UPLOAD_FILE
ADD CONSTRAINT AUDIO_PROCESSING_QUEUE_SOUNDCARD_UPLOAD_FILE_REF_AUDIO_PROCESSING_QUEUE
FOREIGN KEY (AUDIO_PROCESSING_QUEUE)
REFERENCES AUDIO_PROCESSING_QUEUE(AUDIO_PROCESSING_QUEUE_ID);

ALTER TABLE AUDIO_PROCESSING_QUEUE_SOUNDCARD_UPLOAD_FILE
ADD CONSTRAINT AUDIO_PROCESSING_QUEUE_SOUNDCARD_UPLOAD_FILE_REF_SOUNDCARD_UPLOAD_FILE
